export default function Privacy() {
	return (
		<article className='card privacy space-y-4'>
			{/* Заголовок страницы */}
			<h1 className='privacy__title text-2xl font-bold'>
				Политика конфиденциальности
			</h1>

			<p>
				Настоящая Политика конфиденциальности разработана в соответствии с
				Федеральным законом №152-ФЗ «О персональных данных» и регулирует порядок
				сбора, хранения, использования и защиты персональных данных
				пользователей сайта refla.ru.
			</p>

			<h2 className='text-xl font-semibold'>1. Общие положения</h2>
			<p>
				Оператором персональных данных является сайт refla.ru. Используя сайт
				refla.ru, вы соглашаетесь с условиями настоящей Политики.
			</p>
			...
			<p>
				...
				передачи сообщений в Telegram в рамках обработки заявки.
			</p>

			<h2 className='text-xl font-semibold'>5. Сроки хранения</h2>
			<p>
				Персональные данные хранятся в течение срока, необходимого для
				достижения целей обработки, либо до момента отзыва согласия субъектом
				персональных данных.
			</p>
			...
			<p>
				...
				уничтожения, изменения, блокировки, копирования и распространения.
			</p>

			<h2 className='text-xl font-semibold'>8. Изменения политики</h2>
			<p>
				Мы можем обновлять настоящую Политику. Новая редакция вступает в силу с
				момента её размещения на сайте refla.ru.
			</p>
			...
			<p>
				...
				связаться с нами по контактам из соответствующего раздела на сайте
				refla.ru.
			</p>
		</article>
	)
