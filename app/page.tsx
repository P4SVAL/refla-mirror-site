	...
	return (
		<div className='home home__grid'>
			...
			<section className='card home__hero'>
				<div className='home__hero-head'>
					<h1 className='home__hero-title'>
						Зеркала на входные двери под ключ
					</h1>
				...
				<p className='home__hero-text'>
					Преобразите прихожую: визуально расширим пространство, подберём
					безопасное стекло, аккуратно смонтируем. Работаем чисто и быстро.
				</p>
			...
			<section className='card home__why'>
				<h2 className='home__why-title'>Почему с нами удобно</h2>
				<div className='grid'>
			...
			<section className='card home__why'>
				<h2 className='home__why-title'>Как мы работаем</h2>
				<div className='grid'>
			...
			{/* Отзывы (текстовые) */}
			<section className='card home__why'>
				<h2 className='home__why-title'>Отзывы клиентов</h2>
				<div className='grid'>
					{reviews.map((r, i) => (
						<blockquote key={i} className='card home__why-item'>
							<p className='home__why-item-text'>«{r.text}»</p>
							<cite className='title-font' style={{ display: 'block' }}>
								{r.name}
							</cite>
						</blockquote>
					))}
			...
			<section className='card home__why'>
				<h2 className='home__why-title'>Частые вопросы</h2>
				<div className='grid'>
					{faqs.map((f, i) => (
						<details key={i} className='card home__why-item'>
							<summary
								className='home__why-item-title title-font'
								role='button'
							>
								{f.q}
							</summary>
