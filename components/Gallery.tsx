...
export const GALLERY_ITEMS: Item[] = [
	...
	},
	{
		...
		image: '/assets/8.jpg',
		description:
			'Один такой штрих — и обычная дверь превращается в дизайнерский элемент.',
	},
	{
		title: 'Зеркало на входной двери',
		image: '/assets/12.jpg',
		description:
			'Отражение, которое встречает и провожает — и всегда в лучшем свете.',
	},
	{
		title: 'Зеркало на входной двери',
		image: '/assets/13.jpg',
	...
	},
	{
		...
		description:
			'Тут всё просто: стиль, удобство и ощущение, что о доме заботятся.',
	},
	{
		title: 'Зеркало на входной двери',
		image: '/assets/16.jpg',
		description:
			'Солнечный свет, простор и отражение — всё это начинается прямо с двери.',
	},
	{
		title: 'Зеркало на входной двери',
		image: '/assets/17.jpg',
		description:
			'То самое ощущение, когда заходишь домой — и сразу понимаешь: здесь есть вкус.',
	},
]
			...
			{GALLERY_ITEMS.map((it, idx) => (
				<figure key={idx} className='card gallery__item'>
					...
					<figcaption className='gallery__caption'>
						<div className='gallery__description title-font'>
							{it.description}
						</div>
					</figcaption>
				</figure>
